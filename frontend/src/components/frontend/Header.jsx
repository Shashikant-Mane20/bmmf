...
// import { FaInstagram, FaTwitter, FaFacebook, FaLinkedin, FaSearch, FaBars } from "react-icons/fa";
...
//             <FaTwitter className="hover:text-[#FFB422]" />
...
//         {/* Right Section */}
//         <div className="text-black hover:text-[#FFB422] font-light">About Us</div>
//       </div>
...
//           {/* Logo */}
//           <div className="text-2xl font-bold text-[#FFB422]">
