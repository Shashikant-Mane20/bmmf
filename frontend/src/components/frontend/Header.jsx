            ...
            <nav className="bg-white shadow-md">
                <div className="container mx-auto flex items-center justify-between px-4 py-4">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link
                            href="/donate"
                            className="text-[#FFB422] font-bold cursor-pointer">
                               <span> Donate</span>
                        </Link>
              ...
              Donate
                ...
                {/* Mobile Menu */}
                <div
                    className={`md:hidden flex flex-col items-start px-4 py-4 space-y-3 bg-white transition-all duration-500 ease-in-out ${isMenuOpen ? "max-h-screen opacity-100" : "max-h-0 opacity-0 overflow-hidden"
                        }`}
                >
                    <Link
                        href="/"
...
//         {/* Right Section */}
//         <Link href="/about-us">
//           <div className="text-black hover:text-[#FFB422] font-light">
//             About Us
//           </div>
//         </Link>
//       </div>
